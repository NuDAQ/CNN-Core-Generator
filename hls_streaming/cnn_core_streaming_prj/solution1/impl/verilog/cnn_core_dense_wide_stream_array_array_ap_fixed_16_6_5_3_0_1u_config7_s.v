...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((1'b1 == ap_block_state4) | (layer7_out_TREADY_int_regslice == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_block_state4) | (layer7_out_TREADY_int_regslice == 1'b0))) begin
...
always @ (*) begin
    if ((~((1'b1 == ap_block_state4) | (layer7_out_TREADY_int_regslice == 1'b0)) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (layer7_out_TREADY_int_regslice == 1'b1))) begin
