...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cnn_core_shift_line_buffer_array_ap_fixed_16_6_5_3_0_7u_config5_s_void_pooling2d_cl_stg8j BINDTYPE {storage} TYPE {shiftreg} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}
