...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cnn_core_shift_line_buffer_array_ap_fixed_12_6_5_3_0_1u_config3_s_void_conv_2d_buffer_cud BINDTYPE {storage} TYPE {shiftreg} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { void_compute_output_buffer_2d_array_const_ap_shift_reg_n_chan_stream_weig_1 { O 12 vector } void_compute_output_buffer_2d_array_const_ap_shift_reg_n_chan_stream_weig_1_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { void_compute_output_buffer_2d_array_const_ap_shift_reg_n_chan_stream_weig { O 12 vector } void_compute_output_buffer_2d_array_const_ap_shift_reg_n_chan_stream_weig_ap_vld { O 1 bit } } \
} "
}
