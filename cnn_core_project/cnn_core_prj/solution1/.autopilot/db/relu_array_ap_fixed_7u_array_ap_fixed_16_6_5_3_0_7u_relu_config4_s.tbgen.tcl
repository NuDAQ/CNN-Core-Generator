set moduleName relu_array_ap_fixed_7u_array_ap_fixed_16_6_5_3_0_7u_relu_config4_s
set isTopModule 0
...
set C_modelName {relu<array<ap_fixed,7u>,array<ap_fixed<16,6,5,3,0>,7u>,relu_config4>}
set C_modelType { void 0 }
set C_modelArgList {
	{ layer3_out int 63 regular {fifo 0 volatile }  }
	{ layer4_out int 112 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "layer3_out", "interface" : "fifo", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "layer4_out", "interface" : "fifo", "bitwidth" : 112, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer3_out_dout sc_in sc_lv 63 signal 0 } 
	{ layer3_out_num_data_valid sc_in sc_lv 10 signal 0 } 
	{ layer3_out_fifo_cap sc_in sc_lv 10 signal 0 } 
	{ layer3_out_empty_n sc_in sc_logic 1 signal 0 } 
	{ layer3_out_read sc_out sc_logic 1 signal 0 } 
	{ layer4_out_din sc_out sc_lv 112 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer3_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "layer3_out", "role": "dout" }} , 
 	...
 	{ "name": "layer4_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":112, "type": "signal", "bundle":{"name": "layer4_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer3_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "336", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer3_out { ap_fifo {  { layer3_out_dout fifo_data_in 0 63 }  { layer3_out_num_data_valid fifo_status_num_data_valid 0 10 }  { layer3_out_fifo_cap fifo_update 0 10 }  { layer3_out_empty_n fifo_status 0 1 }  { layer3_out_read fifo_port_we 1 1 } } }
	layer4_out { ap_fifo {  { layer4_out_din fifo_data_in 1 112 }  { layer4_out_num_data_valid fifo_status_num_data_valid 0 10 }  { layer4_out_fifo_cap fifo_update 0 10 }  { layer4_out_full_n fifo_status 0 1 }  { layer4_out_write fifo_port_we 1 1 } } }
}
