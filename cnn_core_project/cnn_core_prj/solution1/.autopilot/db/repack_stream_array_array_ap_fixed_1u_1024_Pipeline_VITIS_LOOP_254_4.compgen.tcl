...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in_data16 \
    op interface \
    ports { in_data16_address0 { O 8 vector } in_data16_ce0 { O 1 bit } in_data16_q0 { I 12 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'in_data16'"
}
}
