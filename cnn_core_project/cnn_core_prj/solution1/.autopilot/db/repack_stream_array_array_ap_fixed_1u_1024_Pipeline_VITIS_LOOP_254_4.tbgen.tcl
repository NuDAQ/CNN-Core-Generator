set moduleName repack_stream_array_array_ap_fixed_1u_1024_Pipeline_VITIS_LOOP_254_4
set isTopModule 0
...
set C_modelName {repack_stream<array,array<ap_fixed,1u>,1024>_Pipeline_VITIS_LOOP_254_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_data16 int 12 regular {array 256 { 1 3 } 1 1 }  }
	{ layer11_out int 12 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "in_data16", "interface" : "memory", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_data16_address0 sc_out sc_lv 8 signal 0 } 
	{ in_data16_ce0 sc_out sc_logic 1 signal 0 } 
	{ in_data16_q0 sc_in sc_lv 12 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_data16_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "in_data16", "role": "address0" }} , 
 	{ "name": "in_data16_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_data16", "role": "ce0" }} , 
 	{ "name": "in_data16_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "in_data16", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	in_data16 { ap_memory {  { in_data16_address0 mem_address 1 8 }  { in_data16_ce0 mem_ce 1 1 }  { in_data16_q0 in_data 0 12 } } }
