...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cnn_core.autotvin.dat"
	set constFileTvOut       "cnn_core.autotvout.dat"
	set constFileHdlTvIn     "cnn_core.autohdltvin.dat"
	set constFileHdlTvOut    "cnn_core.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
