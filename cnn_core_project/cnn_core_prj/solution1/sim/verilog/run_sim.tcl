...
if {[file isfile cnn_core.autotvin.dat]} {
	file delete -force cnn_core.autotvin.dat
}

if {[file isfile cnn_core.autotvout.dat]} {
	file delete -force cnn_core.autotvout.dat
}
