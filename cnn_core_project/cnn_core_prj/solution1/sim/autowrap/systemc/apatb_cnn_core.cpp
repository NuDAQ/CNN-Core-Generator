...
void apatb_cnn_core_hw(void* __xlx_apatb_param_input_layer, void* __xlx_apatb_param_layer10_out)
{
  static hls::sim::Stream<hls::sim::Byte<8>> port0 {
    ...
    .name = "input_layer",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_input_layer),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_input_layer),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_input_layer),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_input_layer),
#endif
  };
